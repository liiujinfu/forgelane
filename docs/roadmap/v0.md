...
The current implementation has reached the CLI-first control spine through
...
Still pending for the v0 issue-to-draft-PR loop: generic command AgentAdapter
execution, log segments, terminal run outcomes, commit materialization, branch
push, draft PR creation/update, and stop/retry/request-changes controls.
